...
[Sanctions.NET](https://github.com/IsraelIyonsi/Sanctions.NET) · offline OFAC/UN/EU name screening &nbsp;|&nbsp; [Reconcile.NET](https://github.com/IsraelIyonsi/Reconcile.NET) · rule-based reconciliation &nbsp;|&nbsp; [Mt940.NET](https://github.com/IsraelIyonsi/Mt940.NET) · SWIFT MT940/942 parser &nbsp;|&nbsp; [PaymentWebhooks.NET](https://github.com/IsraelIyonsi/PaymentWebhooks.NET) · verify 5 provider signature schemes &nbsp;|&nbsp; [PaymentCards.NET](https://github.com/IsraelIyonsi/PaymentCards.NET) · card + Verve validation &nbsp;|&nbsp; [Nuban.NET](https://github.com/IsraelIyonsi/Nuban.NET) · Nigerian NUBAN check digit &nbsp;|&nbsp; [Bic.NET](https://github.com/IsraelIyonsi/Bic.NET) · SWIFT BIC (ISO 9362) &nbsp;|&nbsp; [SecurityIds.NET](https://github.com/IsraelIyonsi/SecurityIds.NET) · ISIN/CUSIP/SEDOL/FIGI &nbsp;|&nbsp; [Vat.NET](https://github.com/IsraelIyonsi/Vat.NET) · offline EU/UK VAT &nbsp;|&nbsp; [BusinessCalendar.NET](https://github.com/IsraelIyonsi/BusinessCalendar.NET) · T+n settlement &nbsp;|&nbsp; [FinancialFunctions.NET](https://github.com/IsraelIyonsi/FinancialFunctions.NET) · NPV/IRR/XIRR &nbsp;|&nbsp; [NumberToWords.NET](https://github.com/IsraelIyonsi/NumberToWords.NET) · amounts in words (Naira/kobo)

**Compliance, security and identity**
[Jcs.NET](https://github.com/IsraelIyonsi/Jcs.NET) · RFC 8785 JSON canonicalization &nbsp;|&nbsp; [Pii.NET](https://github.com/IsraelIyonsi/Pii.NET) · PII detection and redaction (incl. NIN/BVN) &nbsp;|&nbsp; [AuditChain.NET](https://github.com/IsraelIyonsi/AuditChain.NET) · tamper-evident hash-chained log &nbsp;|&nbsp; [Mrz.NET](https://github.com/IsraelIyonsi/Mrz.NET) · ICAO 9303 passport MRZ &nbsp;|&nbsp; [Zxcvbn.NET](https://github.com/IsraelIyonsi/Zxcvbn.NET) · password strength &nbsp;|&nbsp; [SafeName.NET](https://github.com/IsraelIyonsi/SafeName.NET) · path/filename sanitization

**Data, text and matching plumbing**
[FixedWidth.NET](https://github.com/IsraelIyonsi/FixedWidth.NET) · flat-file parser &nbsp;|&nbsp; [Mojibake.NET](https://github.com/IsraelIyonsi/Mojibake.NET) · repair garbled encoding &nbsp;|&nbsp; [FuzzMatch.NET](https://github.com/IsraelIyonsi/FuzzMatch.NET) · fuzzy matching &nbsp;|&nbsp; [Phonetics.NET](https://github.com/IsraelIyonsi/Phonetics.NET) · sound-alike name matching &nbsp;|&nbsp; [HumanTime.NET](https://github.com/IsraelIyonsi/HumanTime.NET) · duration parsing &nbsp;|&nbsp; [LlmJson.NET](https://github.com/IsraelIyonsi/LlmJson.NET) · streaming LLM JSON repair &nbsp;|&nbsp; [Json5.NET](https://github.com/IsraelIyonsi/Json5.NET) · JSON5 reader &nbsp;|&nbsp; [EmojiText.NET](https://github.com/IsraelIyonsi/EmojiText.NET) · emoji detect/strip &nbsp;|&nbsp; [Autolink.NET](https://github.com/IsraelIyonsi/Autolink.NET) · URL/mention linkify &nbsp;|&nbsp; [NormalizeUrl.NET](https://github.com/IsraelIyonsi/NormalizeUrl.NET) · URL canonicalization

**Developer productivity**
[TaskGroup.NET](https://github.com/IsraelIyonsi/TaskGroup.NET) · structured concurrency &nbsp;|&nbsp; [MeterBoard.NET](https://github.com/IsraelIyonsi/MeterBoard.NET) · dashboards as code &nbsp;|&nbsp; [DecimalMath.NET](https://github.com/IsraelIyonsi/DecimalMath.NET) · decimal math + penny-exact allocation &nbsp;|&nbsp; [DagAlgorithms.NET](https://github.com/IsraelIyonsi/DagAlgorithms.NET) · topo sort/cycle/scheduler &nbsp;|&nbsp; [ObjectDiff.NET](https://github.com/IsraelIyonsi/ObjectDiff.NET) · structural diffing &nbsp;|&nbsp; [PollAssert.NET](https://github.com/IsraelIyonsi/PollAssert.NET) · Awaitility for .NET &nbsp;|&nbsp; [BarcodeSvg.NET](https://github.com/IsraelIyonsi/BarcodeSvg.NET) · Code128/EAN-13 SVG
...
<p align="center">
  ...
  <img height="170" src="https://github-readme-streak-stats.herokuapp.com/?user=IsraelIyonsi&theme=tokyonight&hide_border=true" />
</p>
